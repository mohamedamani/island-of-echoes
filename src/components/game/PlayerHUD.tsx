...
export const PlayerHUD = ({ stats, timeOfDay, dayCount, isNight }: PlayerHUDProps) => {
  ...
  return (
    <div className="absolute top-4 left-4 right-4 flex justify-between items-start pointer-events-none">
      ...
      {/* Time & Day */}
      <div className="bg-card/90 backdrop-blur-sm rounded-lg p-4 text-center pointer-events-auto">
